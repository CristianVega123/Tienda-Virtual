...
import Car from "../../../assets/icons8-carrito-de-compras-22.png";
            ...
            <section className="flex flex-col items-center gap-3 font-[500]">
                <Link
                    ...
                    className={`text-[18px] h-max p-3 w-full flex justify-center gap-6  ${
                        section && section === SectionAdminSideBar.DASHBOARD
                            ? "border-primary-color border-l-[10px] text-light-primary-color"
                            : "opacity-50"
                    }`}
                >
                ...
                <Link
                    ...
                    className={`text-[18px] h-max p-3 w-full flex justify-center align-baseline gap-6  ${
                        section && section === SectionAdminSideBar.PRODUCTS
                            ? "border-primary-color border-l-[10px] text-light-primary-color"
                            : "opacity-50"
                    }`}
                >
